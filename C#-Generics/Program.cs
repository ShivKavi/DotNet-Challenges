...
namespace GenChallengeSolution
{
    ...
    class Program
    {
        static void Main(string[] args) {
            ...
            Console.WriteLine("There are {0} cars\n", carList.Count);
            List<ClassicCar> fordList = carList.FindAll(FindFords);
            Console.WriteLine("There are {0} Ford cars\n", fordList.Count);
            ...
            Console.WriteLine("The collection contains {0} \n", makes.Keys.Count);
        }
